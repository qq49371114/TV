    ...
    public class RemoteControlServer extends NanoHTTPD {
        ...
        private void addTimeSlot(String start, String end) {
            ...
            Prefers.put("allowed_time_slots", App.gson().toJson(slots));
            showToast("时间段已添加");
        }
        ...
        private void setAppPassword(String password) {
            if (password != null) {
                if (password.isEmpty()) Prefers.remove("app_password");
                else Prefers.put("app_password", password);
                showToast("App 启动密码已更新");
            }
        }

        public static List<TimeSlot> getTimeSlots() {
            String json = Prefers.getString("allowed_time_slots", "[]");
        ...
        private String getAdminPanelHtml() {
            ...
            String password = Prefers.getString("app_password", "");
